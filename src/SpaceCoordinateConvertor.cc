...
{  // Set the start date
  ReferenceDate = DateAndTime(2000,1,1,0,0,0);
...
{ 
  ...
  sun_long = (vl + (1.91946-0.004789*t)*sin(gd)
                          +  0.020094*sin(2.*gd)) * degree;
...
//computation of DipoleSchift in GEO according to Langel, Geomagnetism 1, p 381-390     
